...
/**
 * Event injection to allow modification of the return value of the
 * getColorFromItemStack method in ItemPotion.
 */
public class PotionColorizerEventTransformer extends EventInjectionTransformer {
    ...
    private void addDeglintEvent() {
        addEvent(
                ...
                new MethodInfo(PotionObf.itemPotion,
                        PotionObf.itemPotion_hasEffect, Boolean.TYPE,
                        new Object[] { ItemStack.class }), new MethodHead())
                .addListener(
                        new MethodInfo(
                                "net.easymfne.potioncolorizer.LiteModPotionColorizer",
                                "hasEffect"));
    }
    ...
    /**
     * Add event for catching calls to
     * ItemPotion.getColorFromItemStack(ItemStack, int) for modification.
     */
        ...
        addEvent(
                ...
                new MethodInfo(PotionObf.itemPotion,
                        ...
                        Integer.TYPE, new Object[] { ItemStack.class,
                                Integer.TYPE }), new MethodHead()).addListener(
                new MethodInfo(
                        "net.easymfne.potioncolorizer.LiteModPotionColorizer",
                        "recolorPotion"));
